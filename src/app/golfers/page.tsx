        ...
        <div className="overflow-x-auto rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm">
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-800 text-sm">
            <thead className="bg-gray-50 dark:bg-gray-900">
              <tr>
                <th className="px-4 py-3 text-left font-medium text-gray-500 dark:text-gray-400 sticky top-0 bg-gray-50/95 dark:bg-gray-900/95 backdrop-blur-sm z-10">Rank</th>
                <th className="px-4 py-3 text-left font-medium text-gray-500 dark:text-gray-400 sticky top-0 bg-gray-50/95 dark:bg-gray-900/95 backdrop-blur-sm z-10">Golfer</th>
                <th className="px-4 py-3 text-center font-medium text-gray-500 dark:text-gray-400 sticky top-0 bg-gray-50/95 dark:bg-gray-900/95 backdrop-blur-sm z-10">Avg DFS Pts</th>
                <th className="px-4 py-3 text-center font-medium text-gray-500 dark:text-gray-400 sticky top-0 bg-gray-50/95 dark:bg-gray-900/95 backdrop-blur-sm z-10">Cut Rate</th>
                <th className="px-4 py-3 text-center font-medium text-gray-500 dark:text-gray-400 sticky top-0 bg-gray-50/95 dark:bg-gray-900/95 backdrop-blur-sm z-10">SG: Total</th>
                <th className="px-4 py-3 text-center font-medium text-gray-500 dark:text-gray-400 sticky top-0 bg-gray-50/95 dark:bg-gray-900/95 backdrop-blur-sm z-10">SG: APP</th>
                <th className="px-4 py-3 text-center font-medium text-gray-500 dark:text-gray-400 sticky top-0 bg-gray-50/95 dark:bg-gray-900/95 backdrop-blur-sm z-10">SG: OTT</th>
            ...
            <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
              {golfers.map((g) => (
                <tr key={g.slug} className="hover:bg-gray-50 dark:hover:bg-gray-800">
                  <td className="px-4 py-2 font-medium text-gray-400">#{g.worldRanking}</td>
                  <td className="px-4 py-2">
                    <Link
                      href={`/golfers/${g.slug}`}
                      className="font-medium text-green-700 dark:text-green-400 hover:text-green-800 hover:underline"
                    >
                      {g.name}
                    </Link>
                  </td>
                  ...
                  <td className="px-4 py-2 text-center font-mono">
                    <span className={g.strokesGained.total >= 0 ? 'text-green-700 dark:text-green-400' : 'text-red-600'}>
                      {g.strokesGained.total >= 0 ? '+' : ''}{g.strokesGained.total.toFixed(2)}
                    </span>
                  </td>
                  <td className="px-4 py-2 text-center font-mono">
                    <span className={g.strokesGained.approach >= 0 ? 'text-green-700 dark:text-green-400' : 'text-red-600'}>
                      {g.strokesGained.approach >= 0 ? '+' : ''}{g.strokesGained.approach.toFixed(2)}
                    </span>
                  </td>
                  <td className="px-4 py-2 text-center font-mono">
                    <span className={g.strokesGained.offTheTee >= 0 ? 'text-green-700 dark:text-green-400' : 'text-red-600'}>
                      {g.strokesGained.offTheTee >= 0 ? '+' : ''}{g.strokesGained.offTheTee.toFixed(2)}
                    </span>
                  </td>
                  <td className="px-4 py-2 text-center text-gray-500 dark:text-gray-400 hidden md:table-cell">{g.country}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <section className="mt-16 max-w-3xl">
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none text-gray-600 dark:text-gray-400 space-y-4">
            ...
            <p>
              ...
              alongside the{' '}
              <Link href="/courses" className="text-green-700 dark:text-green-400 hover:underline">
                course pages
              </Link>{' '}
              and the{' '}
